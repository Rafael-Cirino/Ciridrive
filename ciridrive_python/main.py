from main_ciridrive import ciridrive

# from ciridrive_python import ciridrive

ciri = ciridrive(
    client_id="41862169880-ss8pu85bqcs2t498obteo51rbfk8d828",
    client_secret="XCBeKM0UtPooDQT9hnu_Vr88",
)
...
ciri.drive_download("1UFo9knhgqSaYPnUs0IH9haRk3_e1VweO_7_iwEvd3i4")
